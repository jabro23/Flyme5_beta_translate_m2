...
.method public constructor <init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/internal/view/menu/SubMenuBuilder;)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuPresenter;->access$700(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/view/View;
    ...
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuPresenter;->access$800(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/internal/view/menu/MenuView;
    ...
    .end local v8    # "i":I
    .end local v9    # "item":Landroid/support/v7/internal/view/menu/MenuItemImpl;
    ...
    .line 864
    .restart local v9    # "item":Landroid/support/v7/internal/view/menu/MenuItemImpl;
    :cond_3
    # getter for: Landroid/support/v7/widget/ActionMenuPresenter;->mOverflowButton:Landroid/view/View;
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuPresenter;->access$700(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/view/View;
...
.method public onDismiss()V
    ...
    invoke-static {v0, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->access$902(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;)Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;
