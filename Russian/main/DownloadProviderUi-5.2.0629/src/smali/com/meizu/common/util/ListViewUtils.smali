...
.method private animateRemoval(Landroid/widget/ListView;Landroid/view/View;Lcom/meizu/common/util/ListViewUtils$OnListViewFadeListener;)V
    ...
    .line 125
    .local v4, "adapterList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    const/4 v9, 0x0
    ...
    .line 134
    .local v10, "itemId":J
    iget-object v0, p0, Lcom/meizu/common/util/ListViewUtils;->mItemIdTopMap:Ljava/util/HashMap;
    ...
    .line 139
    invoke-interface/range {p3 .. p3}, Lcom/meizu/common/util/ListViewUtils$OnListViewFadeListener;->onEndListViewFadedOut()V
    ...
    new-instance v0, Lcom/meizu/common/util/ListViewUtils$2;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/meizu/common/util/ListViewUtils$2;-><init>(Lcom/meizu/common/util/ListViewUtils;Landroid/view/ViewTreeObserver;Landroid/widget/ListView;Ljava/util/ArrayList;Lcom/meizu/common/util/ListViewUtils$OnListViewFadeListener;)V
...
.method public fadeOutItemView(Landroid/widget/ListView;IILcom/meizu/common/util/ListViewUtils$OnListViewFadeListener;Landroid/widget/BaseAdapter;)V
    ...
    .line 74
    .end local v9    # "alphaValuesHolder":Landroid/animation/PropertyValuesHolder;
    .end local v11    # "animator":Landroid/animation/ObjectAnimator;
    .end local v13    # "endAlphaKey":Landroid/animation/Keyframe;
    .end local v14    # "endTranKey":Landroid/animation/Keyframe;
    .end local v17    # "startAlphaKey":Landroid/animation/Keyframe;
    .end local v18    # "startTranKey":Landroid/animation/Keyframe;
    .end local v19    # "tranValuesHolder":Landroid/animation/PropertyValuesHolder;
    :cond_0
