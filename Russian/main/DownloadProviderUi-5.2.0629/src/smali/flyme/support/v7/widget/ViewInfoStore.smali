...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lflyme/support/v7/widget/ViewInfoStore;->mLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
    ...
    iput-object v0, p0, Lflyme/support/v7/widget/ViewInfoStore;->mOldChangedHolders:Landroid/support/v4/util/LongSparseArray;
...
.method private popFromLayoutStep(Lflyme/support/v7/widget/RecyclerView$ViewHolder;I)Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    .locals 5
    .param p1, "vh"    # Lflyme/support/v7/widget/RecyclerView$ViewHolder;
    .param p2, "flag"    # I
    ...
    .line 105
    iget-object v3, p0, Lflyme/support/v7/widget/ViewInfoStore;->mLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
    ...
    .line 110
    .local v2, "record":Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;
    if-eqz v2, :cond_0
    ...
    iput v3, v2, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->flags:I
    ...
    .line 114
    iget-object v1, v2, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->preInfo:Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    .line 121
    .local v1, "info":Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    :goto_1
    iget v3, v2, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->flags:I
    ...
    .line 115
    .end local v1    # "info":Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    :cond_2
    const/16 v3, 0x8
    ...
    .line 116
    iget-object v1, v2, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->postInfo:Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    .restart local v1    # "info":Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    goto :goto_1
...
.method addToAppearedInPreLayoutHolders(Lflyme/support/v7/widget/RecyclerView$ViewHolder;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    .prologue
    .line 149
    iget-object v1, p0, Lflyme/support/v7/widget/ViewInfoStore;->mLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
    ...
    .line 150
    .local v0, "record":Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;
    if-nez v0, :cond_0
    ...
    .line 154
    :cond_0
    iget v1, v0, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->flags:I

    or-int/lit8 v1, v1, 0x2

    iput v1, v0, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->flags:I
...
.method addToOldChangeHolders(JLflyme/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .prologue
    .line 136
    iget-object v0, p0, Lflyme/support/v7/widget/ViewInfoStore;->mOldChangedHolders:Landroid/support/v4/util/LongSparseArray;
...
.method clear()V
    ...
    .prologue
    .line 58
    iget-object v0, p0, Lflyme/support/v7/widget/ViewInfoStore;->mLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
...
.method process(Lflyme/support/v7/widget/ViewInfoStore$ProcessCallback;)V
    .locals 5
    .param p1, "callback"    # Lflyme/support/v7/widget/ViewInfoStore$ProcessCallback;
    ...
    .line 226
    .local v1, "record":Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;
    iget v3, v1, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->flags:I
    ...
    .line 228
    invoke-interface {p1, v2}, Lflyme/support/v7/widget/ViewInfoStore$ProcessCallback;->unused(Lflyme/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 231
    iget-object v3, v1, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->preInfo:Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    ...
    iget-object v4, v1, Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;->postInfo:Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;

    invoke-interface {p1, v2, v3, v4}, Lflyme/support/v7/widget/ViewInfoStore$ProcessCallback;->processDisappeared(Lflyme/support/v7/widget/RecyclerView$ViewHolder;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-interface {p1, v2, v3, v4}, Lflyme/support/v7/widget/ViewInfoStore$ProcessCallback;->processAppeared(Lflyme/support/v7/widget/RecyclerView$ViewHolder;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-interface {p1, v2, v3, v4}, Lflyme/support/v7/widget/ViewInfoStore$ProcessCallback;->processPersistent(Lflyme/support/v7/widget/RecyclerView$ViewHolder;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Lflyme/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    .line 257
    .end local v1    # "record":Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;
    .end local v2    # "viewHolder":Lflyme/support/v7/widget/RecyclerView$ViewHolder;
    :cond_8
    return-void
.end method
...
.method removeViewHolder(Lflyme/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .prologue
    .line 264
    iget-object v2, p0, Lflyme/support/v7/widget/ViewInfoStore;->mOldChangedHolders:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 270
    :cond_0
    iget-object v2, p0, Lflyme/support/v7/widget/ViewInfoStore;->mLayoutHolderMap:Landroid/support/v4/util/ArrayMap;
    ...
    .line 271
    .local v1, "info":Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;
    if-eqz v1, :cond_1
    ...
    .line 264
    .end local v1    # "info":Lflyme/support/v7/widget/ViewInfoStore$InfoRecord;
    :cond_2
    add-int/lit8 v0, v0, -0x1
